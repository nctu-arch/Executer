...
void regs(struct dep insn, struct dep insn_t){
    ...
    //printf("insn_vartype = %x\n",insn.vartype);
    regVal(insn.vartype,0,insn);
}
...
void regVal(int type, int n, struct dep i_code){
	...
	switch(type){
		case 1: // Rn4 Rd4 Rm4
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
			//n = i_code_t.Rd;
		...
		case 2: // Rn4 Rm4
			...
			//Rn = (insn>>16)&0xF;
			//Rm = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 3: // Rd4 Rm4
			...
			// Rd = (insn>>12)&0xF;
			// Rm = insn&0xF;
		    if(reg_record[i_code.Rd]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 4: // Rn4 Rd4 Rs4 Rm4
			...
			// Rs = (insn>>8)&0xF;
			// Rm = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0||reg_record[i_code.Rs]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 5: // Rn4 Rs4 Rm4
			...
			//Rs = (insn>>8)&0xF;
			//Rm = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rs]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 7: // Rd4 Rs4 Rn4
			...
			// Rs = (insn>>8)&0xF;
			// Rn = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0||reg_record[i_code.Rs]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 11: // Rd4 Ra4 Rm4 Rn4
			...
			// Rm = (insn>>8)&0xF;
			// Rn = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0||reg_record[i_code.Ra]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 13: // RdHi4 RdLo4 Rm4 Rn4
			...
			//Rm = (insn>>8)&0xF;
			//Rn = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.RdHi]>0||reg_record[i_code.RdLo]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 15: // Rn4 Rt4 Rt24
			...
			//Rn = (insn>>16)&0xF;
			//Rt2 = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rt]>0||reg_record[i_code.Rt2]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 16: // Rn4 Rd4 Rt4
			...
			// Rn = (insn>>16)&0xF;
			// Rt = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0||reg_record[i_code.Rt]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 17: // Rn4 Rt4
			...
			//Rt = (insn>>12)&0xF;
			//Rn = (insn>>16)&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rt]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		case 18: // Rn4 Rt4 Rm4
			...
			//Rn = (insn>>16)&0xF;
			//Rm = insn&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rt]>0||reg_record[i_code.Rm]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 20: // Rn4 Rd4
			...
			// Rd = (insn>>12)&0xF;
			// Rn = (insn>>16)&0xF;
		    if(reg_record[i_code.Rn]>0||reg_record[i_code.Rd]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
		...
		case 25: // Rt24 Rt4
			...
			//Rt2 = (insn>>16)&0xF;
			//Rt = (insn>>12)&0xF;
		    if(reg_record[i_code.Rt]>0||reg_record[i_code.Rt2]>0){
                //printf("hazard\n");
			cycle_cnt++;
		    }
		break;
