...
//#if !defined(CONFIG_USER_ONLY)  //yhchiang//
#ifdef CONFIG_GPA   //wswu
//#include "trace_timestamp.h"
target_ulong shadow_tlb[NB_MMU_MODES][CPU_TLB_SIZE];
#endif
//#endif    //yhchiang //
/*//sue7785
#include <sys/types.h>
...
#ifdef CONFIG_GPA  //wswu
	shadow_tlb[mmu_idx][index] = paddr &TARGET_PAGE_MASK;
	//shadow_tlb[mmu_idx][index][1] = (env->hflags & HF_CPL_MASK) == 3 ? 1 : 0;
#endif
