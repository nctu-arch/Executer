...
void regVal(int type, int n){
    ...
    case 1://imm5 Rm3 Rd3
		...
		if(reg_record[Rd]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 3: //Rm3 Rn3 Rd3
		...
		if(reg_record[Rd]>0||reg_record[Rn]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 4: //imm3 Rn3 Rd3
		...
		if(reg_record[Rd]>0||reg_record[Rn]){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 6: //imm8 Rdn3
		...
		if(reg_record[Rd]>0||reg_record[Rd]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 7: //Rm3 Rdn
		...
		if(reg_record[Rm]>0||reg_record[Rd]>0||reg_record[Rn]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 8: //Rm3 Rn3
		...
		if(reg_record[Rm]>0||reg_record[Rn]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 10: //Rn3 Rdm3
		...
		if(reg_record[Rn]>0||reg_record[Rd]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 11: //Rm3 Rd3
		...
		if(reg_record[Rm]>0||reg_record[Rd]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 16: //imm5 Rn3 Rt3
		...
		if(reg_record[Rn]>0||reg_record[Rt]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 17: //Rm3 Rn3 Rt3
		...
		if(reg_record[Rt]>0||reg_record[Rn]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
...
void regVal32(int type,int n){
    ...
    case 3: //Rn4 Rt4 Rd4 imm8
		...
		if(var2flag == 1){
	        ...
	        if(reg_record[Rn]>0||reg_record[Rt]>0||reg_record[Rd]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 5: //Rn4 Rt4 Rt24 imm8
		...
		if(reg_record[Rn]>0||reg_record[Rt]>0||reg_record[Rt2]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 6: //Rt4 Rt24 imm8
		...
		if(reg_record[Rt]>0||reg_record[Rt2]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 8: //Rn4 xxxx xxxx xxxx Rm4
		...
		if(reg_record[Rn]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 17:
		...
		if(reg_record[Rn]>0||reg_record[Rd]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 20:
		...
		if(reg_record[Rn]>0||reg_record[Rt]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 22:
		...
		if(reg_record[Rn]>0||reg_record[Rd]>0||reg_record[Rm]>0||reg_record[Ra]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
    ...
    case 23:
		...
		if(reg_record[Rn]>0||reg_record[((RdHi<<4)|RdLo)]>0||reg_record[Rm]>0){
			{;}
			printf("hazard \n");
			cycle_cnt +=1;
		}
...
int varVal(int type){
    ...
    if(Rd>=0 && Rd!=0xffff)reg_record[Rd]++;
	//printf("type = %d, n = %d\n",type,n);
	{;}
	return n;
}
