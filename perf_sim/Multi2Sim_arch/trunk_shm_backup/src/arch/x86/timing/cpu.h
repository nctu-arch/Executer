...
extern long long x86_max_instr_after_fastforward;//cjc_20130507
...
extern char *x86_cpu_mpki_file_name ;//cjc_20130124
extern FILE *MPKI;

extern long long x86_mpki_interval ;   //cjc_20130208
extern long long x86_mem_dump_interval; //cjc_20130208
...
struct x86_thread_t
{
	...
	long long L1Dcache_Misses;//cjc_20130130
	long long pf_get_from_mem;
	long long pf_mshr;
};
...
struct x86_core_t
{
	...
	long long num_committed_inst;//cjc_20130130
	                               
	long long block_by_mshr_cycle;// there is more information at cpu-issue
	long long block_by_mshr_count;//CIC 
};
...
struct x86_cpu_t
{
	...
	//IC_S_2013_01_29
	long long num_warm_up_inst;
	long long num_warm_up_cycle;
	//IC_E
	long long num_fetched_uinst;
	long long num_dispatched_uinst_array[x86_uinst_opcode_count];
	long long num_issued_uinst_array[x86_uinst_opcode_count];
