...
long long x86_emu_min_inst = 0;//cjc_20130205
long long x86_emu_max_inst = 0;
long long x86_emu_max_cycles = 0;
/* marked by porshe_20130129 (original)
char x86_emu_last_inst_bytes[20];
int x86_emu_last_inst_size = 0;
*/
char x86_emu_last_inst_bytes_0[20];
int x86_emu_last_inst_size_0 = 0;
char x86_emu_last_inst_bytes_1[20];
int x86_emu_last_inst_size_1 = 0;
char x86_emu_last_inst_bytes_2[20];
int x86_emu_last_inst_size_2 = 0;
...
{
	struct x86_ctx_t *ctx;
	context_count = 0;//cjc_20130130
	/* Stop if there is no context running */
	if (x86_emu->finished_list_count >= x86_emu->context_list_count)
		esim_finish = esim_finish_ctx;//return 0;  cjc_20130202 change return 0 to esim_finish = esim_finish_ctx
	...
	/* Return TRUE */
	return (context_count)?context_count:1;//cjc_20130130
}
