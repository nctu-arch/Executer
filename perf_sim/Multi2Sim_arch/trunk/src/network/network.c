...
void net_dump_report(struct net_t *net, FILE *f)
{
	...
	fprintf(f, "\n");
        ...
        //IC_S_2012_12_03
        fprintf(f, "msg_size_8B_num = %lld\n", net->msg_size_8B_num);
        fprintf(f, "msg_size_72B_num = %lld\n", net->msg_size_72B_num);
        fprintf(f, "msg_size_else_num = %lld\n", net->msg_size_else_num);
        fprintf(f, "\n");
 
        fprintf(f, "WAIT EVENT\n");
        fprintf(f, "output_buffer_must_wait_num = %lld\n", net->output_buffer_must_wait_num);
        fprintf(f, "src_C0L1D_dst_L2_output_buffer_must_wait_num = %lld\n", net->src_C0L1D_dst_L2_output_buffer_must_wait_num);
        fprintf(f, "src_C1L1D_dst_L2_output_buffer_must_wait_num = %lld\n", net->src_C1L1D_dst_L2_output_buffer_must_wait_num);
        fprintf(f, "src_C2L1D_dst_L2_output_buffer_must_wait_num = %lld\n", net->src_C2L1D_dst_L2_output_buffer_must_wait_num);
        fprintf(f, "src_C3L1D_dst_L2_output_buffer_must_wait_num = %lld\n", net->src_C3L1D_dst_L2_output_buffer_must_wait_num);
        fprintf(f, "src_L2_output_buffer_must_wait_num = %lld\n", net->src_L2_output_buffer_must_wait_num);

        fprintf(f, "source_output_buffer_busy_num = %lld\n", net->source_output_buffer_busy_num);
        fprintf(f, "src_C0L1D_dst_L2_source_output_buffer_busy_num = %lld\n", net->src_C0L1D_dst_L2_source_output_buffer_busy_num);
        fprintf(f, "src_C1L1D_dst_L2_source_output_buffer_busy_num = %lld\n", net->src_C1L1D_dst_L2_source_output_buffer_busy_num);
        fprintf(f, "src_C2L1D_dst_L2_source_output_buffer_busy_num = %lld\n", net->src_C2L1D_dst_L2_source_output_buffer_busy_num);
        fprintf(f, "src_C3L1D_dst_L2_source_output_buffer_busy_num = %lld\n", net->src_C3L1D_dst_L2_source_output_buffer_busy_num);
        fprintf(f, "src_L2_source_output_buffer_busy_num = %lld\n", net->src_L2_source_output_buffer_busy_num);

        fprintf(f, "link_is_busy_num = %lld\n", net->link_is_busy_num);
        fprintf(f, "src_C0L1D_dst_L2_link_is_busy_num = %lld\n", net->src_C0L1D_dst_L2_link_is_busy_num);
        fprintf(f, "src_C1L1D_dst_L2_link_is_busy_num = %lld\n", net->src_C1L1D_dst_L2_link_is_busy_num);
        fprintf(f, "src_C2L1D_dst_L2_link_is_busy_num = %lld\n", net->src_C2L1D_dst_L2_link_is_busy_num);
        fprintf(f, "src_C3L1D_dst_L2_link_is_busy_num = %lld\n", net->src_C3L1D_dst_L2_link_is_busy_num);
        fprintf(f, "src_L2_link_is_busy_num = %lld\n", net->src_L2_link_is_busy_num);

        fprintf(f, "arbitrator_stall_num = %lld\n", net->arbitrator_stall_num);
        fprintf(f, "src_C0L1D_dst_L2_arbitrator_stall_num = %lld\n", net->src_C0L1D_dst_L2_arbitrator_stall_num);
        fprintf(f, "src_C1L1D_dst_L2_arbitrator_stall_num = %lld\n", net->src_C1L1D_dst_L2_arbitrator_stall_num);
        fprintf(f, "src_C2L1D_dst_L2_arbitrator_stall_num = %lld\n", net->src_C2L1D_dst_L2_arbitrator_stall_num);
        fprintf(f, "src_C3L1D_dst_L2_arbitrator_stall_num = %lld\n", net->src_C3L1D_dst_L2_arbitrator_stall_num);
        fprintf(f, "src_L2_arbitrator_stall_num = %lld\n", net->src_L2_arbitrator_stall_num);

        fprintf(f, "destination_input_buffer_busy_num = %lld\n", net->destination_input_buffer_busy_num);
        fprintf(f, "src_C0L1D_dst_L2_destination_input_buffer_busy_num = %lld\n", net->src_C0L1D_dst_L2_destination_input_buffer_busy_num);
        fprintf(f, "src_C1L1D_dst_L2_destination_input_buffer_busy_num = %lld\n", net->src_C1L1D_dst_L2_destination_input_buffer_busy_num);
        fprintf(f, "src_C2L1D_dst_L2_destination_input_buffer_busy_num = %lld\n", net->src_C2L1D_dst_L2_destination_input_buffer_busy_num);
        fprintf(f, "src_C3L1D_dst_L2_destination_input_buffer_busy_num = %lld\n", net->src_C3L1D_dst_L2_destination_input_buffer_busy_num);
        fprintf(f, "src_L2_destination_input_buffer_busy_num = %lld\n", net->src_L2_destination_input_buffer_busy_num);

        fprintf(f, "destination_input_buffer_full_num = %lld\n", net->destination_input_buffer_full_num);
        fprintf(f, "src_C0L1D_dst_L2_destination_input_buffer_full_num = %lld\n", net->src_C0L1D_dst_L2_destination_input_buffer_full_num);
        fprintf(f, "src_C1L1D_dst_L2_destination_input_buffer_full_num = %lld\n", net->src_C1L1D_dst_L2_destination_input_buffer_full_num);
        fprintf(f, "src_C2L1D_dst_L2_destination_input_buffer_full_num = %lld\n", net->src_C2L1D_dst_L2_destination_input_buffer_full_num);
        fprintf(f, "src_C3L1D_dst_L2_destination_input_buffer_full_num = %lld\n", net->src_C3L1D_dst_L2_destination_input_buffer_full_num);
        fprintf(f, "src_L2_destination_input_buffer_full_num = %lld\n", net->src_L2_destination_input_buffer_full_num);

        fprintf(f, "input_buffer_must_wait_num = %lld\n", net->input_buffer_must_wait_num);
        fprintf(f, "src_C0L1D_dst_L2_input_buffer_must_wait_num = %lld\n", net->src_C0L1D_dst_L2_input_buffer_must_wait_num);
        fprintf(f, "src_C1L1D_dst_L2_input_buffer_must_wait_num = %lld\n", net->src_C1L1D_dst_L2_input_buffer_must_wait_num);
        fprintf(f, "src_C2L1D_dst_L2_input_buffer_must_wait_num = %lld\n", net->src_C2L1D_dst_L2_input_buffer_must_wait_num);
        fprintf(f, "src_C3L1D_dst_L2_input_buffer_must_wait_num = %lld\n", net->src_C3L1D_dst_L2_input_buffer_must_wait_num);
        fprintf(f, "src_L2_input_buffer_must_wait_num = %lld\n", net->src_L2_input_buffer_must_wait_num);

        fprintf(f, "source_input_buffer_busy_num = %lld\n", net->source_input_buffer_busy_num);
        fprintf(f, "src_C0L1D_dst_L2_source_input_buffer_busy_num = %lld\n", net->src_C0L1D_dst_L2_source_input_buffer_busy_num);
        fprintf(f, "src_C1L1D_dst_L2_source_input_buffer_busy_num = %lld\n", net->src_C1L1D_dst_L2_source_input_buffer_busy_num);
        fprintf(f, "src_C2L1D_dst_L2_source_input_buffer_busy_num = %lld\n", net->src_C2L1D_dst_L2_source_input_buffer_busy_num);
        fprintf(f, "src_C3L1D_dst_L2_source_input_buffer_busy_num = %lld\n", net->src_C3L1D_dst_L2_source_input_buffer_busy_num);
        fprintf(f, "src_L2_source_input_buffer_busy_num = %lld\n", net->src_L2_source_input_buffer_busy_num);
       

        fprintf(f, "destination_output_buffer_busy_num = %lld\n", net->destination_output_buffer_busy_num);
        fprintf(f, "src_C0L1D_dst_L2_destination_output_buffer_busy_num = %lld\n", net->src_C0L1D_dst_L2_destination_output_buffer_busy_num);
        fprintf(f, "src_C1L1D_dst_L2_destination_output_buffer_busy_num = %lld\n", net->src_C1L1D_dst_L2_destination_output_buffer_busy_num);
        fprintf(f, "src_C2L1D_dst_L2_destination_output_buffer_busy_num = %lld\n", net->src_C2L1D_dst_L2_destination_output_buffer_busy_num);
        fprintf(f, "src_C3L1D_dst_L2_destination_output_buffer_busy_num = %lld\n", net->src_C3L1D_dst_L2_destination_output_buffer_busy_num);
        fprintf(f, "src_L2_destination_output_buffer_busy_num = %lld\n", net->src_L2_destination_output_buffer_busy_num);

        fprintf(f, "destination_output_buffer_full_num = %lld\n", net->destination_output_buffer_full_num);
        fprintf(f, "src_C0L1D_dst_L2_destination_output_buffer_full_num = %lld\n", net->src_C0L1D_dst_L2_destination_output_buffer_full_num);
        fprintf(f, "src_C1L1D_dst_L2_destination_output_buffer_full_num = %lld\n", net->src_C1L1D_dst_L2_destination_output_buffer_full_num);
        fprintf(f, "src_C2L1D_dst_L2_destination_output_buffer_full_num = %lld\n", net->src_C2L1D_dst_L2_destination_output_buffer_full_num);
        fprintf(f, "src_C3L1D_dst_L2_destination_output_buffer_full_num = %lld\n", net->src_C3L1D_dst_L2_destination_output_buffer_full_num);
        fprintf(f, "src_L2_destination_output_buffer_full_num = %lld\n", net->src_L2_destination_output_buffer_full_num);
        fprintf(f, "\n");
		...
		struct net_node_t *dst_node, int bus_src_buffer, int bus_dst_buffer)
{
	...
	if (src_node->kind == net_node_bus && dst_node->kind != net_node_bus)
	{
		...
		buffer = net_node_add_input_buffer(dst_node);
