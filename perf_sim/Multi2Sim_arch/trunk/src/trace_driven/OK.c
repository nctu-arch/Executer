...
{
//	printf("read core %d \n", core);
	if( core == 0 )return  fread (bufferC0,8,500,mem_access_trace_f_C0);
	else if( core == 1 )return  fread (bufferC1,8,500,mem_access_trace_f_C1);
	else if( core == 2 )return  fread (bufferC2,8,500,mem_access_trace_f_C2);
	else if( core == 3 )return  fread (bufferC3,8,500,mem_access_trace_f_C3);
