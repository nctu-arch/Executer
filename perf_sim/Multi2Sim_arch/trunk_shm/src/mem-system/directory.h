...
int dir_entry_is_sharing(struct dir_t *dir, int x, int y, int z);//cjc_20130417
int dir_entry_get_sharer_count(struct dir_t *dir, int x, int y, int z);//cjc_20130422
int dir_entry_get_the_first_sharer(struct dir_t *dir, int x, int y, int z);//cjc_20130423
#endif
